...
},
{
  ...
  tags: ["leo", "messi","lionel messi","soccer","football","FIFA","argentinian"],
...
},
{
...

 {
  ...
  category: "Musicians",
  picuri:
    "https://live.staticflickr.com/4295/35789467592_741ff5b0f6_c.jpg",
},
    {
  id: "12",
...
"https://cdn.prod.www.spiegel.de/images/c70b4268-cf3f-4ca0-af12-8b99f752541f_w1600_r1.4443909484833894_fpx47.74_fpy44.97.jpg",
},
 {
  ...
  tags: ["bundeskanzlerinmerkel", "merkel", "angela"," politician",  "chancellor",  "german"],
  category: "Politicians",
  picuri:
"https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/2015-12-14_Angela_Merkel_CDU_Parteitag_by_Olaf_Kosinsky_-12.jpg/1920px-2015-12-14_Angela_Merkel_CDU_Parteitag_by_Olaf_Kosinsky_-12.jpg",
  ...
  tags: ["business", "entrepreneur", "investor","author","ceo","richard","branson","richardbranson"],
...
"https://64.media.tumblr.com/dc788aad51e9f7511847b8c68118774b/b8d9bfa01836401d-e4/s500x750/0c9dd1f83ab18eed69ade4037ed915ffd7d97e4d.png",
},
 {
  ...
  category: "Millionaires & Business",
  picuri:
"https://ucarecdn.com/a6fdd41f-7229-4bb4-b627-92dbcc6bc1e6/",
},
    ...
    return (
      <>
        <ScrollView style={styles.scrollView}>
          ...
          >Feeds update automatically every 24 hours. Next update in: {count} </Banner>
          <Searchbar
            placeholder="Search"
          ...
          <List.Section>
           ...
           <Divider />
          <Button style={styles.createFeed}
                    icon="shape-plus"
                    mode="contained"
...
"https://ucarecdn.com/a6fdd41f-7229-4bb4-b627-92dbcc6bc1e6/",
  ...
  */
  ...
  return(
    ...
    {categoryData.filter(function (x) {
        return (
          x.category.includes(routestring)
        );
      }).map((entry) => (
  ...
  return (
    ...
    <Button style={styles.createFeed}
     icon="sticker-plus-outline"
      ...
      {loading ? <Text>Creating a personal feed usually takes ~ 15 seconds</Text> : <Text></Text>}
